package com.example.attaphon_wong.androidthread;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    private void threadImage() throws IOException {
        final URL url = new URL("http://petmaya.com/wp-content/uploads/2014/11/funny-animal-26.jpg");
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.asyncLoadButton:
                ...
                new LoadImageTask().execute("http://petmaya.com/wp-content/uploads/2015/08/funny-face-dog-18.jpg");
            default:
                break;
        }
    }
